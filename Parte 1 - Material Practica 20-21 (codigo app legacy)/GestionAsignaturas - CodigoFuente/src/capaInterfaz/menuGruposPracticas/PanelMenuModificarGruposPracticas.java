...
/** Clase que gestiona el panel del menú para modificar grupos de prácticas.
 *
 * @author Confiencial
 */
public class PanelMenuModificarGruposPracticas  extends JPanel implements ActionListener{

    private static final int MENU_PRINCIPAL = 1;
    private static final int MENU_GRUPOS_PRACTICAS = 5;
    private static final int LISTADO_MODIFICAR_GRUPOS_PRACTICAS = 531;
    private static final int FRAME_ESCOGER_TUTOR = 532;
     ...
     */
    public PanelMenuModificarGruposPracticas(int ancho,int alto){
        this.setLayout(null);
    ...
    private void cargarElementos() {
        JLabel ruta = new JLabel("MENU PRINCIPAL>Grupos de prácticas>Modificar");
        ...
        JButtonOp botonSearch = new JButtonOp("Buscar",LISTADO_MODIFICAR_GRUPOS_PRACTICAS);
    ...
    /** Método que captura los eventos del panel modificar grupos de prácticas y ejecuta
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        switch(b.getNumOperacion()){
            ...
            case FRAME_ESCOGER_TUTOR:
                ...
                break;
            case LISTADO_MODIFICAR_GRUPOS_PRACTICAS:
                try{
                    ...
                    PanelResultadoModificarGruposPracticas pResultadoModificarGrupoPracticas = new PanelResultadoModificarGruposPracticas(ancho,alto);
                    JScrollPane pResultadoConsultarGrupoPracticasConScroll = new JScrollPane(pResultadoModificarGrupoPracticas);
                    ...
                    pResultadoModificarGrupoPracticas.mostrarResultados(resultado);
                    FrameMenuPrincipal.getFramePrincipal().setVisible(true);                    
...
} // fin de la clase PanelMenuModificarGruposPracticas