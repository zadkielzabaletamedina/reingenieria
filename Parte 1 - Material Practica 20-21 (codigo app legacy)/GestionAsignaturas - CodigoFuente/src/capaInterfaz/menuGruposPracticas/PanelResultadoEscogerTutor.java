...
/** Clase que gestiona el panel utilizado para escoger un tutor al dar de alta
 *  un grupo de prácticas.
 *
 * @author Confiencial
 */
public class PanelResultadoEscogerTutor extends JPanel implements ActionListener{
    ...
    /** Crea e inicializa un nuevo PanelResultadoEscogerTutor
     *
     * @param ancho nº de pixels de anchura del panel.
     * @param alto nº de pixels de altura del panel.
     */
    public PanelResultadoEscogerTutor(int ancho,int alto){
        this.setLayout(null);
    ...
    /** Método que captura los eventos del panel escoger tutor
            ...
            case ESCOGER_TUTOR:
                ...
                if (fila != -1){
                    ...
                    try {
                        ...
                        Logger.getLogger(PanelResultadoEscogerTutor.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
                break;
            case CANCELAR:
...
} // fin de la clase PanelResultadoEscogerTutor