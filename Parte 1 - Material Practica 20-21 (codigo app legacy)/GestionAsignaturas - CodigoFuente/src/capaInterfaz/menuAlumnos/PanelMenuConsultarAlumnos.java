...
import capaInterfaz.menuPrincipal.*;
...
/** Clase que gestiona el panel de consulta de alumnos.
 *
 * @author Confiencial
 */
public class PanelMenuConsultarAlumnos extends JPanel implements ActionListener{

    private static final int MENU_PRINCIPAL = 1;
    private static final int MENU_ALUMNOS = 3;
    private static final int LISTADO_CONSULTAR_ALUMNOS = 341;
    ...
    /** Crea e inicializa un nuevo PanelMenuConsultarAlumnos.
     *
     * @param ancho nº de pixels de anchura del panel.
     * @param alto nº de pixels de altura del panel.
     */
    public PanelMenuConsultarAlumnos(int ancho,int alto){
        this.setLayout(null);
    ...
    private void cargarElementos() {
        JLabel ruta = new JLabel("MENU PRINCIPAL>Alumnos>Consultar");
        ...
        JButtonOp botonSearch = new JButtonOp("Buscar",LISTADO_CONSULTAR_ALUMNOS);
    ...
    /** Método que captura los eventos del panel consulta de alumnos
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        switch(b.getNumOperacion()){
            ...
            case MENU_ALUMNOS:
                ...
                FrameMenuPrincipal.getFramePrincipal().setVisible(true);
                break;
            case LISTADO_CONSULTAR_ALUMNOS:
                ...
                try {
                    ...
                    PanelResultadoConsultarAlumnos pResultadoConsultarAlumnos = new PanelResultadoConsultarAlumnos(ancho,alto);
                    JScrollPane pResultadoConsultarAlumnosConScroll = new JScrollPane(pResultadoConsultarAlumnos);
                    ...
                    pResultadoConsultarAlumnos.mostrarResultados(resultado);
                    FrameMenuPrincipal.getFramePrincipal().setVisible(true);
...
} // fin de la clase PanelMenuConsultarAlumnos